...
namespace GGemCo2DCore
{
    ...
    public class GGemCoDialogueBalloonSettings : ScriptableObject
    {
        ...
        /// <summary>
        /// 타자 효과 사운드 기본 재생 속도 배율입니다.
        /// </summary>
        public const float DefaultTypewriterSoundPitchMultiplier = 1f;
        ...
        [Tooltip("타자 효과 사운드 재생 속도 배율입니다. 1이면 원본 속도로 재생합니다.")]
        public float typewriterSoundPitchMultiplier = DefaultTypewriterSoundPitchMultiplier;
        ...
        /// <summary>
        /// 타자 효과 사운드 재생 속도 배율을 안전한 값으로 보정해 반환합니다.
        /// </summary>
        /// <returns>0보다 큰 재생 속도 배율입니다.</returns>
        public float GetSafeTypewriterSoundPitchMultiplier()
        {
            return typewriterSoundPitchMultiplier > 0f
                ? typewriterSoundPitchMultiplier
                : DefaultTypewriterSoundPitchMultiplier;
        }
        ...
        private void Reset()
        {
            ...
            typewriterSoundPitchMultiplier = DefaultTypewriterSoundPitchMultiplier;
        }
    }
}
