...
namespace GGemCo.Scripts
{
    ...
    public static class ConfigResources
    {
        ...
        public static readonly ResourcesAssetInfo SliderMonsterHp = new("GGemCo/UI/Common/SliderMonsterHp");
        public static readonly ResourcesAssetInfo TextDamage = new("GGemCo/UI/Common/TextDamage");
        public static readonly ResourcesAssetInfo TextNpcNameTag = new("GGemCo/UI/Common/TextNpcNameTag");
        public static readonly ResourcesAssetInfo DialogueBalloon = new("GGemCo/UI/Common/UIDialogueBalloon");
        ...
        public static readonly ResourcesAssetInfo SlotBuff = new("GGemCo/UI/Icon/SlotBuff");
