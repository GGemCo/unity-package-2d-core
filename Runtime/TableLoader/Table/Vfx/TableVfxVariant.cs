    ...
    public class TableVfxVariant : DefaultTable<StruckTableVfxVariant>
    {
        ...
        protected override StruckTableVfxVariant BuildRow(Dictionary<string, string> data)
        {
            ...
            return new StruckTableVfxVariant
            {
                ...
                CandidateVfxResourceUid = reader.Int("CandidateVfxResourceUid", reader.Int("CandidateResourceUid", reader.Int("CandidateUid", 0))),
                CandidateAssetKind = reader.Enum<VfxConstants.AssetKind>("CandidateAssetKind"),
                Weight = reader.Int("Weight", 1),
                ScaleOverride = reader.Float("ScaleOverride", 0f),
                DurationOverride = reader.Float("DurationOverride", 0f),
                ColorOverride = reader.String("ColorOverride", string.Empty),
