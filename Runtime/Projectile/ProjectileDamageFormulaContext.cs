...
{
    /// <summary>
    /// 프로젝타일이 실제 대상에 적중한 시점에 데미지를 다시 계산하기 위한 공식 입력 스냅샷입니다.
    /// </summary>
    /// <remarks>
    /// Core 패키지가 Skill 패키지 타입을 직접 참조하지 않도록, 스킬 실행 시점에 필요한 값만 순수 데이터로 전달합니다.
    /// </remarks>
    public sealed class ProjectileDamageFormulaContext
    {
        ...
        /// <summary>
        /// 프로젝타일 적중 시점 재계산용 공식 입력 스냅샷을 생성합니다.
        /// </summary>
        ...
        public ProjectileDamageFormulaContext(
            string formulaKey,
            double baseDamage,
