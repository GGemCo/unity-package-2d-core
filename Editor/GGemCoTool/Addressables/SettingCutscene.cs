...
namespace GGemCo2DCoreEditor
{
    public class SettingCutscene : DefaultAddressable
    {
        ...
        public SettingCutscene(EditorAddressable editorWindow)
        {
        ...
        private void Setup()
        {
            Dictionary<int, Dictionary<string, string>> dictionary = _editorAddressable.TableCutscene.GetDatas();
            ...
            if (groupMonster)
            {
                ...
                {
                    var info = _editorAddressable.TableCutscene.GetDataByUid(outerPair.Key);
